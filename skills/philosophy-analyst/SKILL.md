...
description: |
  哲学思维与逻辑分析专家。用于深度命题分析、逻辑推理、批判性思维、决策分析等高级思维任务。
  当用户需要进行以下操作时使用：(1)全维度命题提取与分析，(2)辩证法与深度逻辑推理，(3)批判性思维分析，(4)结构化解构与溯源分析，(5)复杂概念哲学分析，(6)商业决策分析。
---
...
|------|-----------|----------|-----------|---------|
| **决策分析** | "决策分析"、"决策树"、"利弊分析" | `decision_analysis.md` | `decision_tree.py` | 决策报告 |
| **论证可视化** | "论证分析"、"论证结构"、"逻辑图谱" | `argument_analysis.md` | `argument_mapper.py` | 论证图谱 |
